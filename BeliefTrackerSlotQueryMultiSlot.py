...
class BeliefTracker(nn.Module):
    def __init__(self, args, num_labels, device):
        ...
        # self.utterance_encoder = BertForUtteranceEncoding.from_pretrained(
        #     'bert-base-uncased')
        self.utterance_encoder = torch.load('./bert/encoder.pth')
        ...
        # self.sv_encoder = BertForUtteranceEncoding.from_pretrained(
        #         'bert-base-uncased')
        self.sv_encoder = torch.load('./bert/encoder.pth')
        ########
        #My own code
        save_model = self.sv_encoder
        FILE = './bert/encoder.pth'
        torch.save(save_model, FILE)
